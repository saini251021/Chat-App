...
function SignUp() {
    ...
    const onSubmit = async(data) => {
        ...
        await axios.post("http://localhost:4002/user/signup", userinfo, {withCredentials: true})
        .then((response) => {
            ...
            <div className="flex h-screen items-center justify-center bg-gray-800">
                <form className="border border-white px-6 py-2 rounded-md space-y-3 w-96" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-between text-white font-semibold">
                        ...
                        <button type='submit' value='signup' className="text-white bg-green-500 px-4 py-2 rounded cursor-pointer">SignUp</button>
                    </div>
                </form>
            </div>
        </>
